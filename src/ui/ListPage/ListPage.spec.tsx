...
const MOCK_CHARACTER_DATA: Character[] =
  [
    {
      "name": "Luke Skywalker",
      "height": "172",
...
describe('ListPage', () => {
  it('First', () => {
    render(
      <BrowserRouter>
        <Routes>
          <Route path={PATHS.home} element={<ListPage characters={MOCK_CHARACTER_DATA} />} />
        </Routes>
      </BrowserRouter>
    )
    expect(screen.getAllByTestId('card').length).toBe(MOCK_CHARACTER_DATA.length);
  })
})